...
>
    ...
    <head>
        ...
        <link rel="apple-touch-icon" href="{{url('website/images/favicon/favicon.png')}}">
        <link rel="shortcut icon" type="image/x-icon" href="{{url('website/images/favicon/favicon.png')}}">
                        ...
                        <div class="auth-inner py-2">
                            ...
                            <div class="card mb-0">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title mb-1">@lang("Welcome to Aictec Ecommerce!") 👋</h4>
