...
@section('head_title'){{__('Add District')}}@endsection
@section('content')
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title"> @lang("Add District") </h5>
    ...
    <div class="card-body table-responsive">
        <form class="form-horizontal" action="{{route('app.districts.store')}}" method="post" enctype="multipart/form-data">
            <fieldset>
                @csrf
                @foreach(app_languages() as $key=>$one)
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Dashboard\Districts\StoreRequest') !!}
@endpush
