                            ...
                            <table class="table datatable-basic">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ isset($contact_us->reply_owner_id) ? $contact_us->reply_owner->name : '----------' }}</td>
                                    </tr>
                                    <tr>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Dashboard\ContactUs\UpdateRequest') !!}
